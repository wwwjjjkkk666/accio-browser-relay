...
const TABS_STATE_KEY = 'accio_tabsState'
...
export class TabManager {
  ...
  /** Close every tab in every Accio Agent–titled Chrome tab group (gateway hook). */
  async closeAllAccioAgentGroupTabs() {
    return this.#group.closeAllAccioAgentGroupTabs()
  }
