/**
 * Shared constants for the TydBuddy Browser Relay extension.
 */

export const DEFAULT_CONTROL_PORT = 9236
...
export const STATE_UI = {
  [RelayState.DISABLED]:     { dotColor: null,      title: 'TydBuddy Browser Relay — disabled' },
  [RelayState.DISCONNECTED]: { dotColor: '#F59E0B', title: 'TydBuddy Browser Relay — connecting…' },
  [RelayState.CONNECTED]:    { dotColor: '#2b9ce7', title: 'TydBuddy Browser Relay — connected' },
}
...
export const SETTINGS_KEYS = Object.freeze({
  CLOSE_GROUP_ON_DISABLE: 'tydbuddy_closeGroupOnDisable',
})
